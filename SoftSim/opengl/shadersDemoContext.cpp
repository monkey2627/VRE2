...
{
	s_context = CreateDemoContextOGL();
}
...
void UpdateFluidRenderBuffers(FluidRenderBuffers* buffers, float* particles, int numParticles,  int* indices, int numIndices)
{
	s_context->updateFluidRenderBuffers(buffers, particles,  numParticles, indices,numIndices);
}
void UpdateFluidRenderBuffers(FluidRenderBuffers* buffers, float* particles, int numParticles, float* density, int* indices, int numIndices)
{
	s_context->updateFluidRenderBuffers(buffers, particles, numParticles, density, indices, numIndices);
}
...
void DrawMesh(float* vert, float* norm, float *color, unsigned int* tri,  int triNum) { s_context->drawMesh(vert, norm, color, tri,  triNum); }
