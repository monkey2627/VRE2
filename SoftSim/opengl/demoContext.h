...
class DemoContext
{
	...
	virtual void drawMesh(float* vert, float* norm, float * color, unsigned int* tri,  int triNum) = 0;
	...
	virtual void updateFluidRenderBuffers(FluidRenderBuffers* buffers, Vec4* particles, float* densities, 
		Vec4* anisotropy1, Vec4* anisotropy2, Vec4* anisotropy3, int numParticles, int* indices, int numIndices) = 0;
	virtual void updateFluidRenderBuffers(FluidRenderBuffers* buffers, float* particles,  int numParticles,  int* indices, int numIndices) = 0;
	virtual void updateFluidRenderBuffers(FluidRenderBuffers* buffers, float* particles, int numParticles, float* density, int* indices, int numIndices) = 0;
